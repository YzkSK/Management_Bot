/** Discord招待URL(discord.gg/<code>, discord.com/invite/<code>, discordapp.com/invite/<code>)から招待コードを抽出する。 */
const INVITE_LINK_PATTERN = /(?:discord\.gg|discord(?:app)?\.com\/invite)\/([a-zA-Z0-9-]+)/g;
